 ...
 * 
 */
//ini_set('include_path', $_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR."odata".DIRECTORY_SEPARATOR."library");
 ...
 * @link      http://odataphpproducer.codeplex.com
 */
class SugarCRMDSExpressionProvider implements IExpressionProvider {
    ...
    public function __construct() {
        $this->_entityMapping = CreateSugarCRMMetadata::getEntityMapping();
    }
